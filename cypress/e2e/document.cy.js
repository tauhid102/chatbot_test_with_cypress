...
describe('Enter time questions in the input field', () => {
    ...
    it('First 50 data', () => {
        ...
        cy.fixture('document.json').then((data) => {
            data.forEach((item) => {
                cy.get('#user-input')
                    // .clear()
    ...
    it('Second 50 data', () => {
        ...
        cy.fixture('document2.json').then((data) => {
            data.forEach((item) => {
                cy.get('#user-input')
                    // .clear()
                    .type(item.question).type('{enter}')
    ...
    it('Third 50 data', () => {
        ...
        cy.fixture('document3.json').then((data) => {
            data.forEach((item) => {
                cy.get('#user-input')
                    // .clear()
                    .type(item.question).type('{enter}')
    ...
    it('4th 50 data', () => {
        ...
        cy.fixture('document4.json').then((data) => {
            data.forEach((item) => {
                cy.get('#user-input')
                    // .clear()
                    .type(item.question).type('{enter}')
    ...
    it.only('5th 50 data', () => {
        ...
        cy.fixture('document5.json').then((data) => {
            data.forEach((item) => {
                cy.get('#user-input')
                    // .clear()
                    .type(item.question).type('{enter}')
